    ...
    switch (props.size) {
        case "sm":
            return {
                ...
                option: "py-2 pl-8 pr-3 text-sm",
                icon: "w-4 h-4",
                checkPl: "pl-2",
            };
        case "lg":
            return {
                button: "py-4 pl-5 pr-12 text-lg",
                option: "py-4 pl-12 pr-4 text-lg",
                icon: "w-6 h-6",
                checkPl: "pl-4",
            };
        case "md":
        default:
            return {
                button: "py-3 pl-4 pr-10 text-base",
                option: "py-3 pl-10 pr-4 text-base",
                icon: "w-5 h-5",
                checkPl: "pl-3",
            };
    }
