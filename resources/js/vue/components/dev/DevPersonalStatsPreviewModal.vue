...
const buildMockDailyAttempts = (): DailyAttempts => {
    ...
    for (let index = 0; index < 400; index += 1) {
        ...
        const classic = ((index * 7) % 6) + 1;
        const screenshots = index % 3 === 0 ? ((index * 5) % 5) + 1 : undefined;
        const character = index % 2 === 0 ? ((index * 9) % 7) + 1 : undefined;
...
const viewModel = computed(() => {
    ...
    return {
        ...
        average_attempts: winsTotal > 0 ? Number((attemptsSum / winsTotal).toFixed(2)) : 0,
